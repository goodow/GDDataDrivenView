...
typedef GPB_ENUM(FIRPBSelectContentEvent_FieldNumber) {
  FIRPBSelectContentEvent_FieldNumber_ContentTypee = 1,
  FIRPBSelectContentEvent_FieldNumber_ItemIdd = 2,
};

@interface FIRPBSelectContentEvent : GPBMessage

@property(nonatomic, readwrite, copy, null_resettable) NSString *contentTypee;

@property(nonatomic, readwrite, copy, null_resettable) NSString *itemIdd;
